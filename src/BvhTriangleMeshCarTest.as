package {
	...
	public class BvhTriangleMeshCarTest extends Sprite {
		...
		private function init(e : Event = null) : void {
			...
			// if have very large collision shape(triangle mesh in this demo),
			// need scale the physics world to small, otherwise will appear error becouse some reason
			physicsWorld.scaling = 500;
		...
		private function onCarResourceComplete(event : LoaderEvent) : void {
			...
			for (i = 0; i < car.getNumWheels(); i++) {
				...
				wheel.suspensionRestLength1 = 40;
