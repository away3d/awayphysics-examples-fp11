package  
{
	...
	public class ConstraintTest extends Sprite
	{
		...
		private function init(e:Event = null):void 
		{
			...
			//create a chain with btPoint2PointConstraint and box shape;
			...
			//create a bridge with btHingeConstraint and box shape
			...
			//create a door use btHingeConstraint
			...
			//create a slider use btGeneric6DofConstraint
